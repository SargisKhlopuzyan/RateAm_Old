    ...
    private void populatePurchaseAndSaleTextViews(Organization organization, ExchangeTypeEnum exchangeType, CurrencyTypeEnum currencyType, TextView textViewBankPurchase, TextView textViewBankSale) {
        ...
        switch (exchangeType) {
            ...
            case NonCash:
                switch (currencyType) {
                    case AUD:
                        textViewBankPurchase.setText(organization.currencyList.AUD.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.AUD.nonCash.buy.toString());
                        break;
                    case CAD:
                        textViewBankPurchase.setText(organization.currencyList.CAD.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.CAD.nonCash.buy.toString());
                        break;
                    case XAU:
                        textViewBankPurchase.setText(organization.currencyList.XAU.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.XAU.nonCash.buy.toString());
                        break;
                    case USD:
                        textViewBankPurchase.setText(organization.currencyList.USD.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.USD.nonCash.buy.toString());
                        break;
                    case RUR:
                        textViewBankPurchase.setText(organization.currencyList.RUR.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.RUR.nonCash.buy.toString());
                        break;
                    case JPY:
                        textViewBankPurchase.setText(organization.currencyList.JPY.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.JPY.nonCash.buy.toString());
                        break;
                    case GEL:
                        textViewBankPurchase.setText(organization.currencyList.GEL.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.GEL.nonCash.buy.toString());
                        break;
                    case GBP:
                        textViewBankPurchase.setText(organization.currencyList.GBP.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.GBP.nonCash.buy.toString());
                        break;
                    case EUR:
                        textViewBankPurchase.setText(organization.currencyList.EUR.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.EUR.nonCash.buy.toString());
                        break;
                    case CHF:
                        textViewBankPurchase.setText(organization.currencyList.CHF.nonCash.sell.toString());
                        textViewBankSale.setText(organization.currencyList.CHF.nonCash.buy.toString());
                        break;
                }
                break;
        }
